...
\begin{figure}[htb]
  \begin{center}
   \scalebox{1}{\includegraphics{Boundary_sketch_small.PNG}}
...
\begin{figure}[htb]
  \begin{center}
   \scalebox{0.6}{\includegraphics{wif_sleeping_problems.PNG}}
  % \scalebox{.5}{\input{pager.jpg}}
  \end{center}
...
\begin{figure}[htb]
  \begin{center}
   \scalebox{0.6}{\includegraphics{study_sample.PNG}}
  % \scalebox{.5}{\input{pager.jpg}}
  \end{center}
...
\begin{figure}[htb]
  \begin{center}
   \scalebox{0.15}{\includegraphics{pager.jpg}}
  % \scalebox{.5}{\input{pager.jpg}}
  \end{center}
...
\begin{figure}[htb]
  \begin{center}
   \scalebox{0.5}{\includegraphics{interruption_definition.PNG}}
  % \scalebox{.5}{\input{pager.jpg}}
  \end{center}
